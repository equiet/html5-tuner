...
(function() {
  var audioContext, buffer, bufferFillSize, bufferFiller, canvas, context, div, elFreq, elNeedle, error, fft, fftSize, frequencies, gauss, hp, hr, i, labels, lp, precision, prevNote, sampleRate, scale, success, volume, _i,
  ...
  volume.onaudioprocess = function(e) {
    ...
    return average = max / input.length;
  };
