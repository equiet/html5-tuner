...
(function() {
  var audioContext, buffer, bufferFillSize, bufferFiller, canvas, context, div, elFreq, elNeedle, error, fft, fftSize, gauss, hp, hr, i, lp, sampleRate, scale, success, _i,
  ...
  success = function(stream) {
    ...
    display = {
      draw: function(freq) {
        ...
        return elNeedle.style.webkitTransform = "rotate(" + (Math.floor(freq / 3)) + "deg)";
        /*
