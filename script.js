...
(function() {
  var audioContext, buffer, bufferFillSize, bufferFiller, canvas, context, div, elFreq, elNeedle, error, fft, fftSize, frequencies, gauss, hp, hr, i, labels, lp, sampleRate, scale, success, _i,
  ...
  success = function(stream) {
    ...
    display = {
      draw: function(freq) {
        ...
        if (activeNote) {
          return activeNote.classList.add("active");
        }
      },
      clear: function() {
        var activeNote;
